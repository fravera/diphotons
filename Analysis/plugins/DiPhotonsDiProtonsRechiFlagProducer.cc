#ifndef flashgg_DiPhotonsDiProtonsRechiFlagProducer_h
#define flashgg_DiPhotonsDiProtonsRechiFlagProducer_h
...
namespace flashgg {
    class DiPhotonsDiProtonsRechiFlagProducer : public EDProducer
    {

    public:
        DiPhotonsDiProtonsRechiFlagProducer( const edm::ParameterSet &config ) :
...
typedef flashgg::DiPhotonsDiProtonsRechiFlagProducer DiPhotonsDiProtonsRechiFlagProducer;
DEFINE_FWK_MODULE( DiPhotonsDiProtonsRechiFlagProducer );
